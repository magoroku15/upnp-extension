...
#define FFMPEG_CONFIGURATION "--cc=cc --prefix=/usr/local --disable-debug --enable-memalign-hack --enable-shared --enable-postproc --extra-cflags=-I/usr/local/include/vorbis -I/usr/local/include --extra-ldflags=-L/usr/local/lib -la52 --extra-libs=-pthread --enable-gpl --enable-pthreads --enable-swscale --mandir=/usr/local/man --enable-liba52 --enable-liba52bin --disable-libfaac --enable-libfaad --enable-libfaadbin --disable-libamr-nb --disable-libamr-wb --disable-mmx --disable-libgsm --disable-libmp3lame --disable-ffplay --enable-libtheora --enable-libvorbis --enable-libx264 --disable-libxvid"
...
#define ENABLE_DEV_BKTR_IOCTL_BT848_H 1
#define HAVE_DEV_BKTR_IOCTL_METEOR_H 1
#define ENABLE_DEV_BKTR_IOCTL_METEOR_H 1
...
#define CONFIG_LIBA52BIN 1
#define ENABLE_LIBA52BIN 1
